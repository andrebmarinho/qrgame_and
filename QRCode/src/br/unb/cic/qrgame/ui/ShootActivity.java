...
public class ShootActivity extends Activity implements SurfaceHolder.Callback{
	...
	/**
	 * 
	 * @Brief: inicia o scaneamento, pela câmera, de um possível QRCode.
	 * @return bmp
	 * 
	 */
...
//	    drawScanRect();
        ...
        camera = Camera.open();
        //TODO: Testar se o frame atual do preview é um qrcode (válido) e autenticar o encontro em tempo real.
